...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        runBubbleSortAndJumpSearch(allContacts, entryContacts, fixedUnsortedEntryContacts, linearSearchTime);
        ...
        runJumpSortAndBinarySearch(entryContacts, fixedUnsortedEntryContacts);

    }

    public static void runJumpSortAndBinarySearch(List<String> entryContacts, List<String> fixedUnsortedEntryContacts) {
        ...
        for (int i = 0; i != entryContacts.size(); i++) {
            entries += binarySearch(entryContacts, fixedUnsortedEntryContacts.get(i));
        }
    ...
    public static void runBubbleSortAndJumpSearch(List<String> allContacts, List<String> entryContacts, List<String> fixedUnsortedEntryContacts, long linearSearchTime) {
