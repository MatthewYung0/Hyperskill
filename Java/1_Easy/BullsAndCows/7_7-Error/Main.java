...
public class Main {
    ...
    public static boolean checkValidity(String codeLength) {
        try {
    ...
    public static boolean checkValidity(String codeLength, String range) {
        if (Integer.parseInt(range) > 36) {
            System.out.println("Error: maximum number of possible symbols in the code is 36 (0-9, a-z).");
            return false;
        }
        if (Integer.parseInt(codeLength) > Integer.parseInt(range) || Integer.parseInt(codeLength) == 0) {
            System.out.println("Error: it's not possible to generate a code with a length of " + Integer.parseInt(codeLength) + " with " + Integer.parseInt(range) + " unique symbols.");
            return false;
        }
        return true;
    }
