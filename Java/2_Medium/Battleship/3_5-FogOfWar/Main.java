...
public class Main {
    ...
    public static void run() {
        ...
        cloneArray(battlefield, revealedShips);
    ...
    public static void cloneArray(char[][] originalArray, char[][] arrayCopy) {
        for (int i = 0; i < originalArray.length; i++) {
            arrayCopy[i] = originalArray[i].clone();
        }
    }
    ...
    public static void fireShots(char[][] battlefield) {
        ...
        int column;
        System.out.println("\nThe game starts!");
        while(true/*!allShipsSunken(battlefield)*/) {
            printField(battlefield);
            System.out.println("\nFire a shot!\n");
            do {
            ...
            if (revealedShips[row - 1][column - 1] == STATES.SHIP.getState()) {
                battlefield[row - 1][column - 1] = STATES.HIT.getState();
                revealedShips[row - 1][column - 1] = STATES.HIT.getState();
                System.out.println("\nYou hit a ship!");
            } else {
                battlefield[row - 1][column - 1] = STATES.MISS.getState();
                revealedShips[row - 1][column - 1] = STATES.MISS.getState();
                System.out.println("\nYou missed!");
            }
            break;
        }
        printField(revealedShips);
    }
